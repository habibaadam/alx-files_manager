...
const {putPublish,putUnpublish} = require('../controllers/FilesController')
...
router.post('/files/:id/publish', putPublish)//definition of putPublish
router.post('/files/:id/publish ',putUnpublish)//defination of putUnpublish
